...
public:
  ...
  // コンストラクタ
  MNISTClassification(std::string modeldir, std::string device):
    insize(28 * 28), outsize(10)
  {
    ...
    std::cerr << "model: " << modeldir + "/classification.xml" << std::endl;
...
int main(int argc, char *argv[])
{
  try {
    ...
    MNISTClassification mc(FLAGS_m, FLAGS_d);
